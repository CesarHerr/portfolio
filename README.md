...
**[Portfolio]** This portfolio is a collection of projects showcasing my experience in designing and developing interactive and functional websites. It includes a variety of examples ranging from corporate websites to complex web applications, using technologies such as HTML, CSS, JavaScript, Ruby and frameworks like React and Rails. Additionally, visitors can find details about my focus on usability, responsive design, and performance optimization.
...
- https://cesarherr.github.io/portfolio_1.2
...
```
  cd my-folder
  git clone https://github.com/CesarHerr/portfolio_1.2
```
...
Feel free to check the [issues page](https://github.com/CesarHerr/portfolio_1.2/issues).
